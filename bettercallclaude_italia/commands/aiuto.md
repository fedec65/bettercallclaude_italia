...
La modalità si configura in **Personalizza > Plugin > BetterCallClaude Italia > Impostazioni > Modalità privacy** (default: `balanced`). In modalità `strict`, usare Ollama per elaborare contenuto privilegiato.
