...
description: "Framework legale BetterCallClaude a 5 fasi — pipeline end-to-end che concatena cinque agenti: (1) analisi-doc per intake, (2) italian-legal-research per ricerca precedenti e norme, (3) italian-legal-strategy per forza causa e matrice rischio, (4) adversarial-analysis per stress-test a tre agenti, (5) italian-legal-drafting per il documento verificato. Attiva quando l'utente invoca /bettercallclaude-italia:legale-5step o chiede la pipeline completa, il framework completo o un'analisi end-to-end dall'intake alla redazione. Non attivare per singole fasi (usa i comandi individuali: ricerca, strategia, contraddittorio, redazione, analisi-doc), sole citazioni (italian-citation-formats), domande rapide (italian-legal-research) o sola traduzione (italian-legal-translation). A differenza di /bettercallclaude-italia:flusso (pipeline predefinite), esegue sempre la stessa sequenza fissa a cinque fasi."
---
